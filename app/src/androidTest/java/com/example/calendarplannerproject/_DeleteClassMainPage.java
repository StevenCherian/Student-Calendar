...
public class _DeleteClassMainPage {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void _DeleteClassMainPage() {
        ...
        ViewInteraction textInputEditText = onView(
                allOf(withId(R.id.nameforClass),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText.perform(replaceText("Test C"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatToggleButton = onView(
                allOf(withId(R.id.toggle_2), withText("T"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatToggleButton2 = onView(
                allOf(withId(R.id.toggle_4), withText("T"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.day_picker),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.NoClassesText),
                        isDisplayed()));
