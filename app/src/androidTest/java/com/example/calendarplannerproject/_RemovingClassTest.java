...
public class _RemovingClassTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void _RemovingClassTest() {
        ...
        ViewInteraction textInputEditText = onView(
                allOf(withId(R.id.nameforClass),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText.perform(replaceText("CMSC"), closeSoftKeyboard());
        ...
        DataInteraction relativeLayout = onData(anything())
                .inAdapterView(allOf(withId(R.id.classListView),
                        childAtPosition(
